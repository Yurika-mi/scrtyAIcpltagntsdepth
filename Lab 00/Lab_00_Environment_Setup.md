...
2. **[ロールと管理者]** ページの検索バーで、`特権ロール管理者` を検索(1)し、 **[特権ロール管理者 (2)]** のロール名を選択します。
...
5. [Copilot Studio の Entra エージェント ID] の設定パネルで、まだ設定されていない場合は **[オン (1)]** を選択し、**[保存 (2)]** をクリックします。
...
9. [確認が必要です] というポップアップが表示されたら、[このリクエストを確認し、送信元を信頼します (1)] のチェックボックスをオンにし、[アクセスを許可 (2)] を選択します。
...
13. エージェント設定ページの右上隅で、**[公開]** を選択します。

     ![](./media/Lab-00-71.png)

14. 確認ダイアログで、**公開する**を選択して確定します。
