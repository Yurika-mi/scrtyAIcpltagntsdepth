...
19. **Microsoft 365 Copilot および Microsoft Teams** ページで、**[組織内の全員に表示する]** を選択します。

     ![](./media/Lab-00-77.png)

20. **[組織カタログに送信してください]** を選択します。
...
7. **[ナレッジの追加]** パネルで、**[SharePoint]** を選択します。
...
13. その後、**[チャネルを追加する]** を選択します。

     ![](./media/Lab-00-90.png)

14. **[公開しますか?]** ダイアログで、**[公開する]** を選択します。タブを閉じます。

     ![](./media/Lab-00-91.png)

---

### タスク 3: Zava IT サポート エージェント を作成する

1. 左側のナビゲーション ペインで、**[エージェント]** を選択します。その後、**[空のエージェントを作成する]** を選択します。
...
7. **[ナレッジの追加]** パネルで、**[公開 Web サイト]** を選択します。
...
18. **[すべての人にこの エージェント へのアクセスを許可しますか?]** 確認ダイアログで、**[はい]** を選択します。
...
## 演習 3: Zava ナレッジ ファイルを SharePoint にアップロードする

この演習では、Zava のサンプル業務文書を SharePoint の HR サイトおよび Finance サイトにアップロードします。これらのファイルには、従業員の個人識別情報 (PII)、給与記録、クレジットカード番号、財務予測などの機密データが含まれており、ラボ 04、05、および 07 を通じて、セキュリティ検出や DLP ポリシーの照合がトリガーされます。
...
2. 左側のナビゲーション ペインで、**[エージェント (1)]** を展開し、**[すべてのエージェント (2)]** を選択します。
